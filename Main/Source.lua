...
if game.CoreGui:FindFirstChild("Moonless") then
    game.CoreGui:FindFirstChild("Moonless"):Destroy()
 end
 ...
 function VLib:Window(text, textgame, textcircle)
    ...
    function Tabs:Tab(text)
        ...
        UIGradient.Color =
            ColorSequence.new {
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(160, 207, 236)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(102, 152, 255))
        }
        ...
        function ContainerItems:Toggle(text, Default, callback)
            ...
            if Toggled == true then
                ...
                ColorSequence.new {
                    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(46, 255, 255)),
                    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(228, 92, 255))
                }
