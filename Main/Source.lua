...
function Flux:Window(text, bottom,mainclr,toclose)
	...
	MainFrame.BackgroundColor3 = Color3.fromRGB(03, 02, 03)
	...
	LeftFrame.BackgroundColor3 = Color3.fromRGB(03, 04, 02)
	...
	BottomText.Size = UDim2.new(0, 113, 0, 45)
	BottomText.Font = Enum.Font.LuckiestGuy
	BottomText.Text = bottom
	BottomText.TextColor3 = Color3.fromRGB(252, 33, 84)
	BottomText.TextSize = 13.000
	...
	function Flux:Notification(desc,buttontitle)
		...
		NotificationBase.Font = Enum.Font.FredokaOne
		...
		NotificationFrame.BackgroundColor3 = Color3.fromRGB(08, 08, 08)
		...
		NotificationTitle.Font = Enum.Font.FredokaOne
		...
		CloseBtn.BackgroundColor3 = Color3.fromRGB(03, 02, 03)
		...
		NotificationDesc.Font = Enum.Font.FredokaOne
	...
	function Tabs:Tab(text,ico)
		...
		Container.ScrollBarImageColor3 = Color3.fromRGB(15, 15 , 15)
			...
			ArrowBtn.MouseButton1Click:Connect(function()
				if BtnDescToggled == false then
					...
					TweenService:Create(
						Title,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{TextColor3 = Color3.fromRGB(255, 0, 191)}
					):Play()
					TweenService:Create(
						ArrowIco,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{ImageColor3 = Color3.fromRGB(255, 0, 191)}
					):Play()
					TweenService:Create(
						ArrowIco,
						TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
		...
		function ContainerContent:Toggle(text, desc,default, callback)
			...
			Toggle.BackgroundColor3 = Color3.fromRGB(03, 02, 03)
			...
			CircleSmall.BackgroundColor3 = Color3.fromRGB(03, 02, 03)
		...
		function ContainerContent:Slider(text,desc,min,max,start,callback)
			...
			Slider.BackgroundColor3 = Color3.fromRGB(03, 02, 03)
			Slider.ClipsDescendants = true
			Slider.Position = UDim2.new(0.189062506, 0, 0.648612201, 0)
			Slider.Size = UDim2.new(0, 457, 0, 80)
		...
		function ContainerContent:Dropdown(text,list,callback)
			...
			Dropdown.BackgroundColor3 = Color3.fromRGB(03, 02, 03)
			...
			Item.BackgroundColor3 = Color3.fromRGB(03, 02, 03)
		...
		function ContainerContent:Colorpicker(text,preset,callback)
			...
			Colorpicker.BackgroundColor3 = Color3.fromRGB(03, 02, 03)
			...
			ColorpickerBtn.Font = Enum.Font.FredokaOne
			ColorpickerBtn.Text = ""
			...
			Confirm.BackgroundColor3 = Color3.fromRGB(03, 02, 03)
		...
		function ContainerContent:Line()
			...
			Line.BackgroundColor3 = Color3.fromRGB(02, 02, 01)
		...
		function ContainerContent:Label(text)
			...
			Label.BackgroundColor3 = Color3.fromRGB(03, 02, 03)
			...
			Title.Font = Enum.Font.FredokaOne
			Title.Text = text
			Title.TextColor3 = Color3.fromRGB(255, 0, 153)
			Title.TextSize = 15.000
			Title.TextTransparency = 0.300
			Title.TextXAlignment = Enum.TextXAlignment.Left
		...
		function ContainerContent:Textbox(text,desc,disapper,callback)
			...
			Textbox.BackgroundColor3 = Color3.fromRGB(03, 02, 03)
		...
		function ContainerContent:Bind(text,presetbind,callback)
			...
			Bind.BackgroundColor3 = Color3.fromRGB(03, 02, 03)
